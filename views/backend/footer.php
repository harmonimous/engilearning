...
<!-- END Header Layout di header.php -->
    ...
    <!-- Flatpickr -->
    <script src="<?php echo get_directory('assets');?>vendor/flatpickr/flatpickr.min.js"></script>
    <script src="<?php echo get_directory('assets');?>js/flatpickr.js"></script>
    
    <!-- Initialize -->
    <script src="<?php echo get_directory('assets');?>js/nestable.js"></script>
    <script src="<?php echo get_directory('assets');?>js/touchspin.js"></script>
</body>
</html>