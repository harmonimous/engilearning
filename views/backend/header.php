...
<head>
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet" href="<?php echo get_directory('assets');?>css/nestable.css">
    <link rel="stylesheet" href="<?php echo get_directory('assets');?>css/nestable.rtl.css">
    ...
    <!-- Flatpickr -->
    <link type="text/css" href="<?php echo get_directory('assets');?>css/flatpickr.css" rel="stylesheet">
    <link type="text/css" href="<?php echo get_directory('assets');?>css/flatpickr.rtl.css" rel="stylesheet">
    <link type="text/css" href="<?php echo get_directory('assets');?>css/flatpickr-airbnb.css" rel="stylesheet">
    <link type="text/css" href="<?php echo get_directory('assets');?>css/flatpickr-airbnb.rtl.css" rel="stylesheet">
            ...
            <div class="mdk-header__content">
                ...
                <nav id="default-navbar" class="navbar navbar-expand navbar-dark bg-primary m-0">
                    <div class="container-fluid">
                        ...
                        <!-- Brand -->
                        <a href="<?=site_url('profile');?>" class="navbar-brand">
                        ...
                        <ul class="nav navbar-nav flex-nowrap">
                            ...
                            <li class="nav-item dropdown ml-1 ml-md-3">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="<?=set_url('profile');?>">
                                        <i class="material-icons">person</i> <?=get_user_info('nama_user');?>
                                    </a>
                                    <a class="dropdown-item" href="<?=set_url('logout');?>">
