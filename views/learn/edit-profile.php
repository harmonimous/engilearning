                                ...
                                <form id="form-profile" action="update" enctype="multipart/form-data">
                                    <div class="list-group-item">
                                        <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                            <div class="form-row">
                                                <label class="col-md-3 col-form-label form-label">NIM</label>
                                                <div class="col-md-9">
                                    ...
                                    <div class="list-group-item">
                                        <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-9">
                                                    <input id="nama-dosen" name="nama-dosen" type="text" value="<?=$detail->nama_mahasiswa;?>" class="form-control form-control-prepended">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="list-group-item">
                                        <div role="group" aria-labelledby="label-profilename" class="m-0 form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-9">
                                                    <input id="email" type="email" placeholder="Your profile name" name="email" value="<?=$detail->email;?>" class="form-control form-control-prepended">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="media align-items-center">
                                                        <div class="media-body">
                                                            <div class="custom-file" id="fileupload">
                                                                <input type="file" id="gambar" name="gambar" class="dropify" data-default-file="<?=base_url('uploaded/images/').$detail->gambar_mahasiswa;?>">
                                                                <small id="description-display_realname" class="form-text text-muted">Ukuran gambar maksimal 2 MB</small>
                                                                <input value="<?=$detail->gambar_mahasiswa;?>" type="hidden" name="filelama" id="filelama"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div data-perfect-scrollbar>
                            <div class="page-section pt-lg-32pt">
                                <ul class="nav page-nav__menu">
                                    <li class="nav-item">
                                        <a href="<?=site_url('mahasiswa/profile');?>" class="nav-link">Kembali ke Profil</a>
                                    </li>
                                    <li class="nav-item">
